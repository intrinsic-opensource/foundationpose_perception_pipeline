...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--foundation-stereo-max-width", type=int, default=settings.resolution.stereo.max_width)
    parser.add_argument("--foundation-stereo-fixed-height", type=int, default=settings.resolution.stereo.fixed_height)
